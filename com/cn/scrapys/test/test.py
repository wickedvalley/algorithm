...
def getPassword(numbers):
    ...
    password=(str(ctx.call('getValues', str(numbers),'192.168.255.176','74:c6:3b:12:1f:2b')))
    print password
    return password
...
def login(username,password):
    ...
    url='http://portal.ikuai8.com/Action/webauth-up?type=1&action=release&username='+str(username)+'&password='+str(password)+'&refer='
    print "请求地址url：",url
    headers={
        'Host':'portal.ikuai8.com',
        'Referer':'http://portal.ikuai8.com/templates/custom/user.html?type=1&_r=400389761&terminal=pc&template=custom&gwid=d9835d80160fb7e9f0032f9f37960041&router_ver=2.7.12&mac=74:c6:3b:12:1f:2b&user_ip=192.168.255.176&timestamp=1529809804&apmac=40:a5:ef:99:ff:d4&bssid=40:a5:ef:99:ff:d5&ssid=LBZhotel&firmware=IK-RouterOS&refer=',
